...
int main(int argc, char **argv)
{
	...
	if (optind < argc)
	{
		...
		cmd_args = (char **)malloc(nb_cmd_args * sizeof(char *));
		if (trace_on)
		{
...
static struct isp_command isp_cmds_list[] = {
	{0, (char *)"unlock", 0, NULL},
	{1, (char *)"write-to-ram", 3, isp_cmd_write_to_ram},
	{2, (char *)"read-memory", 3, isp_cmd_read_memory},
	{3, (char *)"prepare-for-write", 2, isp_cmd_prepare_for_write},
	{4, (char *)"copy-ram-to-flash", 3, isp_cmd_copy_ram_to_flash},
	{5, (char *)"go", 2, isp_cmd_go},
	{6, (char *)"erase", 2, isp_cmd_erase},
	{7, (char *)"blank-check", 2, isp_cmd_blank_check},
	{8, (char *)"read-part-id", 0, NULL},
	{9, (char *)"read-boot-version", 0, NULL},
	{10, (char *)"compare", 3, isp_cmd_compare},
	{11, (char *)"read-uid", 0, NULL},
	{-1, NULL, 0, NULL}};
